...
def add_friend():
    ...
    if len(new_friend.name) > 0 : #and new_friend.name.isdigit() == False and \
                 #   re.match(pattern_n,new_friend.name)!=None and re.match(pattern_s,new_friend.salutation)!=None and \
                  #  new_friend.age > 12 and new_friend.rating < 50 and re.match(pattern_a,new_friend.age)!=None and \
                   # new_friend.salutation.y ==  True and new_friend.rating >= 0 and re.match(pattern_r,new_friend.rating)!=None:
